...
while True:
    website = (
        input("\nSelect a News website ( The News / Sky Sports ): ").strip().title()
    )
    ...
    if website == "The News":
        ...
        print("\nCategories: Football, Cricket, Tennis, F1, NBA")

        category = input("Enter a category: ").lower().strip()
        ...
        print("...\nAn error occured, please choose from the shown websites...\n")
